...
Version 0.28.1 supports authenticated network radio nodes, receive-only USB RTL-SDR,
...
device. The sensor-recovery test firmware `0.13.0-sensor.1` combines receive, generalized sensor
