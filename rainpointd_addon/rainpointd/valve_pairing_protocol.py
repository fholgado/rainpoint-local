...
CALIBRATED_FREQUENCY_OFFSET_HZ = 45_000
INITIAL_REPLY_TARGET_HZ = 433_506_030
ROUTINE_REPLY_TARGET_HZ = 434_351_001
INITIAL_REPLY_CHANNEL_HZ = (
    INITIAL_REPLY_TARGET_HZ - CALIBRATED_FREQUENCY_OFFSET_HZ
)
ROUTINE_REPLY_CHANNEL_HZ = (
    ROUTINE_REPLY_TARGET_HZ - CALIBRATED_FREQUENCY_OFFSET_HZ
)
