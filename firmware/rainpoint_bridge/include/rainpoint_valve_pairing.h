...
constexpr std::uint16_t kHtv405ReplyDelayMs = 49;
...
constexpr std::array<Htv405PairingStep, kHtv405PairingStepCount>
    ...
    {{{0x00, 0x80, 0x84, 0x02, 0xff, 0x93, 0x13, 0x00, 0x00, 0xbd, 0x84, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}}, {{0x80, 0xc0, 0x85, 0x85, 0x03, 0x02, 0x70, 0x00, 0x9d, 0x97, 0x91, 0x0d, 0x01, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}}, true, 0x4f03, 433511445, 0x43},
...
inline bool buildAutomaticHtv405Profile(
    ...
    for (std::size_t index = 1; index < profile.steps.size(); ++index) {
        profile.steps[index].channelCenterHz = 433426408;
    }
